...
{
  motion_draw_viewer.init();
  motion_draw_viewer.init_websocket('wss://localhost','9080','motion_draw');
}
...
var motion_draw_viewer = new function()
{
  this.REQUEST_GET_ID           = 0;
  this.REQUEST_GET_CLIENT_LIST  = 1;
  this.REQUEST_ADD_MOTION       = 2;
...
function websocket_onopen()
{
  ...
  var request = {'request_type' : motion_draw_viewer.REQUEST_GET_CLIENT_LIST};
